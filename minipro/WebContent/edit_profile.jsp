...
<div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-fixed-top bg-dark border-bottom elevation-1">
            ...
            <span class="ml-2" style="font-weight: 600; font-size: x-large; color: white">Edit Profile</span>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center" style="width:100%"style=" background: rgba(31, 31, 31,1);border-top-right-radius: 10px;">
            	...
            	<div class="col-lg-9 col-7 col-sm-9 col-md-9 py-3"><br><br><br>
            		...
            		<form class="container mt-2" action="change_profile_controller" >
                <h2>Edit Profile</h2>
    
      <div class="form-row">
        <div class="form-group col-sm-6 col-md-3 col-md-offset-3 ">
          <label>First Name</label>
          <input type="text" class="form-control  form-control-lg" name="fname" value="${usr.firstName}">
        </div>
        <div class="form-group col-sm-6 col-md-3 ">
        <label>Last Name</label>
          <input type="text" class="form-control  form-control-lg" name="lname" value="${usr.lastName}">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group  col-sm-12 col-md-6  col-md-offset-3">
          <label>Email</label>
          <input type="email" class="form-control  form-control-lg" name="emailid" id="inputEmail" value="${usr.email}">
        </div>
      </div>
      <div class="form-row">
         <div class="form-group col-sm-12 col-md-6  col-md-offset-3">
         <label>Password</label>
          <input type="password" id="inputPassword" name="pw" class="form-control  form-control-lg" value="${usr.pwd}" aria-describedby="passwordHelpInline">
      ...
      <div class="form-row">
         ...
         <label>Mobile No</label>
          <input type="number" id="inputNumber" name="mob"  class="form-control  form-control-lg" value="${usr.mobileno}">
        </div>
      </div>

      <div class="form-row" id="org" >
        <div class="form-group  col-sm-12 col-md-6 col-md-offset-3" >
        <label>Organization</label>
          <input type="text" name="organization" class="form-control  form-control-lg" value="${usr.organization}">
        </div>   
      </div>
            <div class="form-row" id="org" >
        <div class="form-group  col-sm-12 col-md-6 col-md-offset-3" >
          <input type="hidden" name="role" class="form-control  form-control-lg" value="${usr.role}">
        </div>   
      </div>
      <div class="form-row">
        <div class="form-group  col-sm-10 col-md-2 col-md-offset-3">
