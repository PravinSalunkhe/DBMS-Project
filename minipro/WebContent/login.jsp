...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                              <a class="nav-link" href="">Login for Host </a>
                            </li>
                          </ul>
                        </div>
                      </nav>
	...
	<div class="container-fluid py-3">
		...
		<form method="post" action="logincontroller">
			...
			<h2 align="center">Login for Host</h2>
			<br>
			<input type="hidden" name="Role" class="form-c	ontrol" value="Host" id="Role">
			  ...
			  <div class="row justify-content-md-center justify-content-sm-center justify-content-xs-center">
			    ...
			    <div class="col-xs-5 col-sm-7 col-md-7 col-lg-7">
			      <input type="password" name="passw" class="form-control form-control-lg" id="inputPassword3" placeholder="Password">
			    </div>
			  </div>
			  <div class="row justify-content-md-center justify-content-sm-center justify-content-xs-center">
