...
<%@page import="com.minipro.model.Notification"%>
...
<div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-fixed-top bg-dark border-bottom elevation-1">
            ...
            <span class="ml-2" style="font-weight: 600; font-size: x-large; color: white">Notifications</span>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                                      <a href="notifications_controller" class="nav-link " style="color:#fff;background-color: rgba(255,255,255,0.1)">
            ...
            <div class="row justify-content-center" style="width:100%"style=" background: rgba(31, 31, 31,1);border-top-right-radius: 10px;">
            	...
            	<div class="col-lg-10 col-7 col-sm-9 col-md-9 py-3"><br><br>
						...
						<%
		    				...
		    				temp=(List<Notification>)request.getAttribute("notification_list");			
      						if(!temp.isEmpty())
      						{	
	      						for(Notification m : temp)
	      						{
	      				%>
			 			
			 			<div class="alert alert-info mt-3" role="alert">
 			 				<b class="text-dark""><%=m.getNote() %>
 							</b><small class="float-right"><%=m.getN_date() %></small>
						</div>
						...
						<% } 
      					...
      					%>
      						<div class="alert alert-info mt-3" role="alert">
    			 				<b class="text-dark""><center>You don't have any notifications right now.</center></b>
   							</div>
   						<% 	
      						}
  						%>
