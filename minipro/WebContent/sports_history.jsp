            ...
            <div class="row justify-content-center" style="width:100%">
                ...
                <div class="col-lg-3 col-5 col-sm-3 col-md-3 justify-content-center" style=" background-color: #f1f0fe">
                        ...
                        <div class="vertical-nav navigate" id="sidebar">
                                ...
                                <ul class="navbar-nav ">
                                  <li class="nav-item" >
                                    <a href="your_events_controller" class="nav-link p-2" style="text-align: center">
                                              <b>Your Events</b>    
                                          </a>
                                  </li> 
                                  <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                      ...
                                      <li class="nav-item" style="background-color: #6A5ACD">
                                          <a href="event_history.jsp" class="nav-link text-white p-2 active" style="text-align: center">
                                                    <b>Event History</b>    
                                                </a>
                                        </li> 
                                </ul>                      
