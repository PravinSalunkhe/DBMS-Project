            ...
            <div class="row justify-content-center" style="width:100%">
                ...
                <div class="col-lg-3 col-5 col-sm-3 col-md-3 justify-content-center" style=" background-color: #f1f0fe">
                         ...
                         <div class="vertical-nav navigate" id="sidebar">
                                ...
                                <ul class="navbar-nav ">
                                  <li class="nav-item" >
                                    <a href="your_events.jsp" class="nav-link" style="text-align: center">
                                              <b>Your Events</b>    
                                          </a>
                                  </li> 
                                  <li class="nav-item">
                                      <a href="event_create.jsp" class="nav-link " style="text-align: center">
                                                <b>Create Events</b>    
                                            </a>
                                    </li> 
                                    <li class="nav-item">
                                        <a href="#" class="nav-link p-2" style="text-align: center">
                                                  <b>Enter Sports</b>    
                                              </a>
                                      </li> 
                                      <li class="nav-item" style="background-color: #6A5ACD">
                                          <a href="events_history.jsp" class="nav-link p-2  text-white active" style="text-align: center">
                                                    <b>Event History</b>    
                                                </a>
                                        </li> 
                                </ul>                      
...
<div class="row justify-content-center p-2">
    ...
    <a href="sports_history.jsp"  class="btn btn-primary mr-2">View Details</a>
     </div>
    </div>
</div>
