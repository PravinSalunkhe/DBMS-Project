...
<div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-fixed-top bg-dark border-bottom elevation-1">
            ...
            <span class="ml-2" style="font-weight: 600; font-size: x-large; color: white">Schedule Your Event</span>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                                      <a href="schedule_event" class="nav-link" style="color:#fff;background-color: rgba(255,255,255,0.1)">
                                      	<i class="fa fa-database nav-icon" aria-hidden="true"></i>
            ...
            <div class="row justify-content-center" style="width:100%"style=" background: rgba(31, 31, 31,1);border-top-right-radius: 10px;">
            	...
            	<div class="col-lg-9 col-7 col-sm-9 col-md-9 py-3"><br><br><br>
            		...
            		<div class="container bg-white p-4">
  					...
  					<c:url var="view" value="viewschedule">	
      					<c:param name="eventname" value="<%=eventname %>"></c:param>
						<c:param name="sportname" value="<%=sportname %>"></c:param>
						<c:param name="city" value="<%=city %>"></c:param>
						<c:param name="fees" value="<%=Integer.toString(fees) %>"></c:param>
						<c:param name="date" value="<%=date %>"></c:param>
						<c:param name="totalparti" value="<%=Integer.toString(totalparti) %>"></c:param>
	      			</c:url>
            	
            	
    				<form action="viewschedule" method="get">
    					<input type="hidden" name="eventname" class="form-control" id="eventname" value="<%=eventname %>">
    					<input type="hidden" name="sportname" class="form-control" id="sportname" value="<%=sportname %>">
    					
    					<input type="hidden" name="city" class="form-control" id="city" value="<%=city %>">
    					<input type="hidden" name="fees" class="form-control" id="fees" value="<%=fees %>">
						<input type="hidden" name="date" class="form-control" id="date" value="<%=date %>">
						<input type="hidden" name="totalparti" class="form-control" id="totalparti" value="<%=totalparti %>">
								  	...
								  	<tr>
								  		...
								  		%>
								  			...
								  			<% }else{ %>
								  				...
								  				<%} %>
								  		<% }else{ %>
								  			<input type="text" name="<%=match.get(i).getMatch_id() %>" class="form-control" id="<%=match.get(i).getMatch_id() %>" placeholder="Enter winner team">
						...
						<%} %>
            				...
            				%>	  
							 ...
							 <%} %>
					  		...
					  		<div>
					  			<button class="btn btn-primary float-right mt-4 p-2">Proceed to next Round</button>                                 
                          	</div> 
                      </form>
