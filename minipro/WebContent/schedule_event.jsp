            ...
            <div class="row justify-content-center" style="width:100%"style=" background: rgba(31, 31, 31,1);border-top-right-radius: 10px;">
            	...
            	<div class="col-lg-9 col-7 col-sm-9 col-md-9 py-3"><br><br><br>
            			...
            			<%
      					...
      					s=(List<Sport>)request.getAttribute("sport_list");  
      				...
      				<c:url var="view" value="viewschedule">	
						...
						<c:param name="date" value="<%=m.getSport_date() %>"></c:param>
						<c:param name="totalparti" value="<%=Integer.toString(m.getTotal_participation()) %>"></c:param>
	      			</c:url>
                          ...
                          <div class="row justify-content-center p-2">
                              ...
                              <div class="container bg-white p-4">
									  ...
									  <div class="row">
                                       ...
                                       <div>
                                        <a class="btn btn-primary float-right mt-4 p-2" href="${view}">View Schedule</a>
                                      </div>         
                              </div>
